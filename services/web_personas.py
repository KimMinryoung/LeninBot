...
- Soviet/communist-history figures, institutions, events, or terms → commulingo_people FIRST (search(q) across all categories, then get_person / get_term / get_event / get_office), then supplement with knowledge_graph_search / web_search
