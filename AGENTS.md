...
- On the production server, when running as root, edit project files and run Git as `grass`. Cloud sessions have no `grass` user and run as root; the rule does not apply there.
