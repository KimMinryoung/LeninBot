...
# 1. 설정
# 마르크스/엥겔스 저작 연도별 색인 페이지를 시작점으로 잡습니다.
START_URL = "https://www.marxists.org/archive/marx/works/index.htm"
OUTPUT_DIR = "./docs/marx_engels"
DELAY = 0.3
...
def crawl(url, depth):
    ...
    for a in links:
        ...
        # 마르크스/엥겔스의 저작 경로(works) 내부에 있고, htm 확장자이며, 이미 방문하지 않은 경우만
        if "marxists.org/archive/marx/works/" in full_url:
...
# 실행
print("🚀 마르크스/엥겔스 저작 크롤링을 시작합니다. (상당한 시간이 소요될 수 있습니다.)")
crawl(START_URL, 0)
