...
from roleplay.dynamics import isolation_stage, holdout_titles, open_bargains, routine_occurrences, RESOLVE_EVENT_KINDS
...
def actor_state_view(state, user_text=""):
    ...
    from roleplay.illness import actor_view
