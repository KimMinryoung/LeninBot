...
RESEARCH_TOOL_SPEC = {
    ...
    "description": (
        ...
        "for sensory detail in a night scene.' Reuse earlier sourced briefs for answered questions; "
        "wording changes and manuscript save errors do not need another research call. "
        "Use it when missing evidence would ground the fiction; you never "
...
_RESEARCH_SYSTEM_PROMPT = (
    ...
    "first results don't settle the question. Start with search_depth='basic'; advanced is only for "
    "a specific unresolved fact that needs more context. Stop once the question has adequate evidence; "
    "do not search paraphrases of facts already supported. Further searches must resolve missing evidence, "
    "a contradiction or plausible changes. If the paid budget is exhausted, return supported findings "
    "and label the remaining uncertainty rather than retrying.\n"
